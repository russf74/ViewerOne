...
Firmware for the ESP32-2432S028R-style board: USB serial at **115200**, JSON lines: `{"t":"Title","c":"1999","l":true,"m":false}` (`c` = release year; muted = yellow on navy; unmuted = green on black).
