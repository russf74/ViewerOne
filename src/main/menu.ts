...
const startHelp =
  ...
  '4. Cubase: Song PC updates the display only. CrowPanel ALL (Group1) sends ch1 CC88 mute (0=muted, 127=live; same as FX CC85) and bridges to X32 mute group 1 (ch2/CC80). CrowPanel FX (Group6) bridges to X32 mute group 6 (ch2/CC85; mute-group polarity 0=active). SYNTH/PIANO pads send ch1 CC86/CC87 mute (127=muted, 0=live; inverted vs FX) on ViewerOneToCubase — map Jump/Value Generic Remote to Group1 Mute / mixer ch1/ch2 Mute. PC 125 = blackout. PC 126 = dim royal blue knight rider (between songs). PC 127 = apply lights for the displayed song.\n\n' +
