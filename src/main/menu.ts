...
const startHelp =
  ...
  '5. Countdown / transport: MIDI realtime Start/Stop (0xFA/0xFC), MMC Play/Stop, or mapped notes/CCs (default ch16 note 60/61 — editable in Detail → Transport MIDI). Press Play and look for MIDI spy lines tagged TRANSPORT (filter: Transport only). Song PCs and mute CCs are normal and ignored for countdown; if nothing tagged TRANSPORT appears, route Clock/MMC/Generic Remote to CubaseToViewerOne.\n\n' +
